...
class DashboardView(QWidget):
    def __init__(self, secrets_manager, sync_manager):
        ...
        # ESTADOS / FRAMES ANIMACIONES
        self.internet_frames = [
            "🌐 Internet (activo)",
            "🌐💨 Internet (activo)",
            "🌐✨ Internet (activo)"
        ]
        ...
        self.supabase_frames = [
            "☁️📡 Transmitiendo datos…",
            "☁️📶 Transmitiendo datos…"
        ]
        ...
        self.internet_anim_timer.start(600)
